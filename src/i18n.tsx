...
export const translations: Record<Locale, Dictionary> = {
  en: {
    ...
    popupCurrentLocation: 'Current location',
    status_ok: 'OK',
    ...
    moving: 'Moving...',
    badgeMoving: 'Click new location to move this point',
    confirmMove: 'Confirm',
    cancelMove: 'Cancel',
  ...
  sv: {
    ...
    popupCurrentLocation: 'Nuvarande position',
    status_ok: 'OK',
    ...
    movingPoint: 'Flyttar punkt',
    moving: 'Flyttar...',
    badgeMoving: 'Klicka ny plats för att flytta denna punkt',
